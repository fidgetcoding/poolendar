...
// in lib/theme.tsx.
const themeInitScript = `(function(){try{var t=localStorage.getItem('meowlendar-theme');document.documentElement.dataset.theme=t==='dark'?'dark':'light'}catch(e){document.documentElement.dataset.theme='light'}})()`
